...
export const IcHelp = (p: React.SVGProps<SVGSVGElement>) => S(p, <><circle cx="12" cy="12" r="8.5" /><path d="M9.6 9.4a2.5 2.5 0 1 1 3.2 2.9c-.6.2-.9.7-.9 1.3v.5" /><circle cx="12" cy="17" r="1" fill="currentColor" /></>);
